...
class ParserError extends Error {
    constructor(e,  { text, position, offset, line, col }) {
        super(e);
        Error.captureStackTrace(this, this.constructor);
        this.message = e.message || e;
        this.name = this.constructor.name;
...
class Interpreter {
    ...
    __PRODUCT (node,context) {
        try {
            switch (node.operator) {
                case "/": return new Decimal(this._build(node.left,context) || NaN).div(new Decimal(this._build(node.right,context)) || NaN).toNumber(); break;
