...
class Interpreter {
    ...
    __DATE_AND_TIME (node,context) {
        ...
        try {
            ...
            } else if (parameters !== null && typeof parameters === 'object' && parameters.hour && parameters.minute && parameters.second && parameters.offset) {
                //result = Time.build([parameters.hour, parameters.minute, parameters.second]).add(parameters.offset);
                //result = Time.build([parameters.hour, parameters.minute, parameters.second, parameters.offset]);
                result = Time.build({ ...parameters });
            } else if (parameters !== null && typeof parameters === 'object' && parameters.hour && parameters.minute && parameters.second) {
                result = Time.build([parameters.hour, parameters.minute, parameters.second]);
