...
var grammar = {
    ...
    {"name": "PrePathExpression", "symbols": ["InstanceOf"]},
    {"name": "PrePathExpression", "symbols": ["PathExpression"]},
    {"name": "PrePathExpression", "symbols": ["FilterExpression"]},
    {"name": "PrePathExpression", "symbols": ["Interval"]},
    {"name": "PrePathExpression", "symbols": ["FunctionInvocation"]},
    {"name": "PrePathExpression", "symbols": ["Literal"]},
    {"name": "PrePathExpression", "symbols": [{"literal":"("}, "_", "Expression", "_", {"literal":")"}], "postprocess": (data) => { return new Node({ node: Node.EVAL, expression: data[2] }); }},
    ...
    {"name": "SimplePositiveUnaryTest", "symbols": ["FunctionInvocation"]},
    {"name": "SimplePositiveUnaryTest", "symbols": ["Literal"]},
    ...
    {"name": "ArithmeticNegation", "symbols": [{"literal":"-"}, "_", {"literal":"-"}, "_", "NonArithmeticExpression"], "postprocess": (data) => { return new Node({ node: Node.EVAL, expression: reduce(data[4]) });}},
    ...
    {"name": "NameStart$ebnf$2", "symbols": [(lexer.has("types") ? {type: "types"} : types)], "postprocess": id},
    {"name": "NameStart$ebnf$2", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "NameStart", "symbols": [(lexer.has("word") ? {type: "word"} : word), "NameStart$ebnf$1", "NameStart$ebnf$2"], "postprocess": (data) => { return concat(data)}},
    ...
    {"name": "NamePart", "symbols": [(lexer.has("dayandtime") ? {type: "dayandtime"} : dayandtime)], "postprocess": (data) => { return concat(data)}},
    {"name": "NamePart", "symbols": [(lexer.has("number") ? {type: "number"} : number)], "postprocess": (data) => { return concat(data)}},
    ...
    {"name": "FunctionName", "symbols": [(lexer.has("yearsandmonthduration") ? {type: "yearsandmonthduration"} : yearsandmonthduration)], "postprocess": (data) => { return new Node({ node: Node.NAME, value: concat([data]) }); }},
    ...
    {"name": "PathExpression", "symbols": ["PrePathExpression", {"literal":"."}, "Name"], "postprocess": (data) => { return new Node({ node: Node.PATH, object:reduce(data[0]), property:data[2]});}},
    ...
    {"name": "Comparison$subexpression$2", "symbols": [{"literal":"="}]},
    {"name": "Comparison$subexpression$2", "symbols": [{"literal":"!="}]},
    {"name": "Comparison", "symbols": ["Expression", "__", "Comparison$subexpression$2", "__", "List"], "postprocess": (data) => { return new Node({ node: Node.COMPARISON, operator: reduce(data[2]).value, left: reduce(data[0]), right: reduce(data[4])});}},
    {"name": "Comparison$subexpression$3", "symbols": [{"literal":"="}]},
    {"name": "Comparison$subexpression$3", "symbols": [{"literal":"!="}]},
    {"name": "Comparison", "symbols": ["List", "__", "Comparison$subexpression$3", "__", "Expression"], "postprocess": (data) => { return new Node({ node: Node.COMPARISON, operator: reduce(data[2]).value, left: reduce(data[0]), right: reduce(data[4])});}},
    ...
    {"name": "BasicType", "symbols": [(lexer.has("daysandtimeduration") ? {type: "daysandtimeduration"} : daysandtimeduration)], "postprocess": (data) => { return concat(data)}},
    {"name": "BasicType", "symbols": [(lexer.has("daysandtime") ? {type: "daysandtime"} : daysandtime)], "postprocess": (data) => { return concat(data)}},
    {"name": "BasicType", "symbols": [(lexer.has("yearsandmonthduration") ? {type: "yearsandmonthduration"} : yearsandmonthduration)], "postprocess": (data) => { return concat(data)}},
    {"name": "BoxedExpression", "symbols": ["List"]},
    {"name": "BoxedExpression", "symbols": ["FunctionDefintion"], "postprocess": (data) => { return reduce(data);}},
    {"name": "BoxedExpression", "symbols": ["Context", "__", "Expression"], "postprocess": (data,location,reject) => { return new Node({ node: Node.BOXED, context: reduce(data[0]), result: reduce(data[2]) }); }},
