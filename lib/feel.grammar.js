...
var grammar = {
    Lexer: lexer,
    ParserRules: [
    {"name": "main", "symbols": ["UnaryTests"], "postprocess": (data) => { return new Node({ node: Node.UNARYTESTS, test: reduce([data]) }); }},
    ...
    {"name": "SimplePositiveUnaryTest$subexpression$1", "symbols": [{"literal":">"}]},
    {"name": "SimplePositiveUnaryTest$subexpression$1", "symbols": [{"literal":">="}]},
    {"name": "SimplePositiveUnaryTest", "symbols": ["SimplePositiveUnaryTest$subexpression$1", "__", "Endpoint"], "postprocess": (data) => { return new Node({ node: Node.UNARY, operator: reduce(data[0]).value, value: reduce(data[2]) }); }},
    ...
    {"name": "UnaryTests", "symbols": ["Expression", "_", {"literal":"in"}, "_", "Interval"]},
    {"name": "UnaryTests", "symbols": ["Expression", "_", {"literal":"in"}, "_", "List"]},
    {"name": "UnaryTests", "symbols": [{"literal":"not"}, "_", {"literal":"("}, "_", "PositiveUnarytests", "_", {"literal":")"}], "postprocess": (data) => { return new Node({ node: Node.NOT, test: reduce(data[4]) }); }},
    {"name": "UnaryTests", "symbols": ["_", {"literal":"-"}, "_"], "postprocess": (data) => { return new Node({ node: Node.DASH }); }},
    ...
    {"name": "Name", "symbols": ["NameStart", "Name$ebnf$1"], "postprocess": (data, location, reject) => { if (isKeyword(concat([data[0]]))) return reject; return new Node({ node: Node.NAME, value: concat([data]) }); }},
    ...
    {"name": "StringLiteral", "symbols": [(lexer.has("string") ? {type: "string"} : string)], "postprocess": (data) => { return new Node({ node: Node.STRING, value: concat(data) }); }},
    ...
    {"name": "FunctionInvocation", "symbols": ["Name", "_", "Parameters"], "postprocess": (data, location, reject) => { if(isKeyword(concat([data[0]]))) return reject;  return new Node({ node: Node.FUNCTION_CALL, name: reduce(data[0]), parameters: reduce(data[2]) });}},
    ...
    {"name": "PositionalParameterList", "symbols": ["Expression", "_", "PositionalParameterList$ebnf$1"], "postprocess": (data) => { return new Node({ node: Node.LIST, entries: [].concat(data[0]).concat(extractObj(data[2],2)) });}},
    ...
    {"name": "Comparison", "symbols": ["Expression", "__", {"literal":"in"}, "__", "PositiveUnarytest"], "postprocess": (data) => { return new Node({ node: Node.COMPARISON, operator: reduce(data[2]).value, left: reduce(data[0]), right: reduce(data[4])});}},
    {"name": "Comparison", "symbols": ["Expression", "__", {"literal":"in"}, "_", {"literal":"("}, "_", "PositiveUnarytests", "_", {"literal":")"}], "postprocess": (data) => { return new Node({ node: Node.COMPARISON, operator: reduce(data[2]).value, left: reduce(data[0]), right: reduce(data[6])});}},
    ...
    {"name": "BoxedExpression", "symbols": ["FunctionDefintion"]},
    ...
    {"name": "List", "symbols": [{"literal":"["}, "_", "Expression", "_", "List$ebnf$1", "_", {"literal":"]"}], "postprocess": (data) => { return new Node({ node: Node.LIST, entries: [].concat(reduce(data[2])).concat(reduce(extractObj(data[4],2))) });}},
    {"name": "FunctionDefintion", "symbols": [{"literal":"function"}, "_", {"literal":"("}, "_", "FormalParameterList", "_", {"literal":")"}, "_", "Expression"], "postprocess": (data) => { return new Node({ node: Node.FUNCTION_DEFINITION, parameters: reduce(data[4]), expression: reduce(data[84]) });}},
    ...
    {"name": "FormalParameterList", "symbols": ["FormalParameter", "_", "FormalParameterList$ebnf$1"], "postprocess": (data) => { return new Node({ node: Node.LIST, entries: [].concat(data[0]).concat(extractObj(data[2],2)) });}},
    {"name": "FormalParameter$ebnf$1$subexpression$1", "symbols": [{"literal":":"}, "_", "Type"]},
    {"name": "FormalParameter$ebnf$1", "symbols": ["FormalParameter$ebnf$1$subexpression$1"], "postprocess": id},
    {"name": "FormalParameter$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "FormalParameter", "symbols": ["Name", "_", "FormalParameter$ebnf$1"], "postprocess": (data) => { return new Node({ node: Node.FORMAL_PARAMETER, name: concat(data[0]), type: reduce(data[4]) });}},
