...
Exponentiation
  	= head:UnaryExpression tail:(__ $("**") __ UnaryExpression)*
       { return { node:"Exponentiation", head, tail, text:text() };}
...
Multiplicative
    =  head:Exponentiation tail:(__ MultiplicativeOperator __ Exponentiation)*
        { return { node:"Multiplicative", head, tail, text:text() };}

Additive
    = head:Multiplicative tail:(__ $("+"/"-") __ Multiplicative)*
        { return { node:"Additive", head, tail, text:text() };}
